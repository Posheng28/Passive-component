...
const COMPANIES = [
  ...
  { name:'晶技', ticker:'3042', groups:['freq'], groupLabel:'頻率/RF',
    products:'石英晶體、XO、TCXO、OCXO、VCXO、32kHz振盪器',
    catalyst:'台灣第一大、全球前三大石英頻率元件廠（市占10%）；EV每台需求較燃油車高80%；2024年華新科入股強化生態系整合；2026/4月營收創19個月新高',
    ai:3, car:5, price:3, scarce:3, platform:1, color:'#00acc1' },
  ...
  { name:'富致', ticker:'3147', groups:['prot','res'], groupLabel:'保護元件',
