...
const COMPANIES = [
  ...
  { name:'信昌電', ticker:'6173', groups:['cap','res','ind'], groupLabel:'電容',
  ...
  { name:'台嘉碩', ticker:'3221', groups:['freq'], groupLabel:'頻率/RF',
  ...
  { name:'富致', ticker:'6642', groups:['prot','res'], groupLabel:'保護元件',
